    ...
    <div class="container-search">
        <form method="GET" action="{{ route('course') }}">
            <div class="row">
                ...
                <input class="btn btn-submit-search" type="submit" name="filter_submit" value="{{ __('message.search') }}">
            </div>
            <div class="mt-20 border-btn-input filter-form row">
                <span class="mr-30">{{ __('message.filter_by') }}</span>
                <div class="form-group row mr-10">
                    <div class="mr-10">
                        ...
                        <label for="newest" class="newest">{{ __('message.newest') }}</label>
                    </div>
                    <div class="mr-10">
                        ...
                        <label class="oldest" for="oldest">{{ __('message.oldest') }}</label>
                    </div>
                </div>
                ...
                <div class="form-group mr-10">
                    <select name="learner" id="learner" class="select2">
                        <option value="">{{ __('message.number_of_learners') }}</option>
                        ...
                        >{{ __('message.decrease') }}</option>
                    </select>
                </div>
                <div class="form-group mr-10">
                    <select name="time" id="time" class="select2">
                        <option value="">{{ __('message.study_time') }}</option>
                        <option value="{{ config('course.sort_low_to_hight') }}"
                ...
                <div class="form-group mr-10">
                    <select name="lesson" id="lesson" class="select2">
                        <option value="">{{ __('message.number_of_lessons') }}</option>
                        <option value= "{{ config('course.sort_low_to_hight') }}"
                ...
                <div class="form-group mr-10">
                    <select name="rate" id="rate" class="select2">
                        <option value="">{{ __('message.reviews') }}</option>
                        <option value="{{ config('course.sort_low_to_hight') }}"
        ...
        <div class="courses-item col-5">
            <div class="course-info row">
                ...
                <div class="info-detail col-9">
                    ...
                    <div class="course-description">{{ Str::limit($course->describe),300 }}</div>
